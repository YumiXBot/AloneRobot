...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("AloneRobot/resources/bg.jpg")
    ...
    font = ImageFont.truetype('AloneRobot/resources/SwanseaBold-D0ox.ttf', size=40)
    welcome_font = ImageFont.truetype('AloneRobot/resources/SwanseaBold-D0ox.ttf', size=60)
...
@app.on_message(filters.command("swelcome", prefixes=["/", "!"]) & ~filters.private)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "AloneRobot/resources/profilepic.jpg"
...
Iᴅ: {message.chat.id}
Usᴇʀɴᴀᴍᴇ: @{message.chat.username}
➖➖➖➖➖➖➖➖➖➖➖➖**
""")
